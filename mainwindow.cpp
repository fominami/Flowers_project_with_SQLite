...

{
    ...
    db.setDatabaseName("C:\\Users\\USer\\Documents\\lab_2.db");
    if (!db.open()) {
    ...
    palette.setColor(QPalette::Window, QColor(173, 216, 230)); // Нежно-голубой цвет
    setPalette(palette);
...
void MainWindow::on_pushButton_2_clicked()
{
    ...
    if (ok) {
        ...
        QMessageBox::critical(this, "AAAAA", "PROBLEM");
    }
}
...
void MainWindow::on_pushButton_3_clicked()
{
    ...
    else{ QMessageBox::warning(this,"Лох","Ну герой,ввел не число");}
}
...
void MainWindow::on_pushButton_6_clicked()
{
    ...
    if(!ok)
    {
        QMessageBox::warning(this,"ТЫ","ЧИСЕЛКУ ВВЕДИ");
    }
...
void MainWindow::on_pushButton_7_clicked()
{
    ...
    {
        label_13->setText("Логин может содержать строчные латин.\n буквы, цифры, нижнее подчеркивание,\n длина 5-15 символов");
